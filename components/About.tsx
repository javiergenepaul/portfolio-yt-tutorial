            ...
            <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="space-y-10 px-0 md:px-10">
                    ...
                    <p className="text-base">
                        ...
                        mauris et justo maximus feugiat. Donec non mauris libero. Quisque rutrum,
                        ante eget feugiat cursus, turpis nunc dignissim eros, nec tempus ante leo a
                        enim. Morbi a tellus ac lorem ultricies dictum a vel risus. Maecenas nec
                        viverra mi. Vivamus tempus justo nec tincidunt tincidunt. Pellentesque sit
                        amet tortor eu ipsum porttitor rhoncus. Aliquam ut luctus quam, id porttitor
                        felis. Integer mattis vulputate nisi, quis tempor ligula ornare sit amet.
                        Nulla blandit nulla vel risus aliquet scelerisque. Nullam bibendum, ante vel
                        posuere egestas, purus ante efficitur quam, fringilla ornare velit sem eget
                        libero. Donec lacinia nisi magna, et ullamcorper urna efficitur euismod.
                        Curabitur elementum blandit erat in scelerisque. Pellentesque rutrum lectus
                        eget risus rutrum rhoncus.
                    </p>
                </div>
            </div>
        </motion.div>
